"""PTUPCDR — personalized cross-domain mapping benchmark.

Lesson 2: PTUPCDR uses a per-user hypernetwork (MoE) to map movie preferences
to game embeddings. Few-shot blending: source_weight = 1/(1+k_games).
"""
...
def main() -> None:
    ...
    save_result(
        ...
        description="PTUPCDR (EMCDR backbone), emb=64, SOURCE:20+TARGET:20, meta=30, 8 experts",
    )
